...
namespace EVMS
{
            ...
            valveDataRows = new List<ValveReadingRow>
    {
       ...
       new ValveReadingRow { SerialNumber = 11, GrooveDia = "12.5", STNG = "1", STNU = "2", GroovePositon = "1", SeatRo = "1", HeadDia = "34.2", SeatHeight = "32", DatumToEnd = "64", DatuToGroove = "50", OverLeght = "102" },
        new ValveReadingRow { SerialNumber = 12, GrooveDia = "13", STNG = "3", STNU = "4", GroovePositon = "2", SeatRo = "2", HeadDia = "35", SeatHeight = "33", DatumToEnd = "66", DatuToGroove = "52", OverLeght = "104" },
        new ValveReadingRow { SerialNumber = 13, GrooveDia = "12.5", STNG = "1", STNU = "2", GroovePositon = "1", SeatRo = "1", HeadDia = "34.2", SeatHeight = "32", DatumToEnd = "64", DatuToGroove = "50", OverLeght = "102" },
        new ValveReadingRow { SerialNumber = 14, GrooveDia = "13", STNG = "3", STNU = "4", GroovePositon = "2", SeatRo = "2", HeadDia = "35", SeatHeight = "33", DatumToEnd = "66", DatuToGroove = "52", OverLeght = "104" },
        new ValveReadingRow { SerialNumber = 15, GrooveDia = "12.5", STNG = "1", STNU = "2", GroovePositon = "1", SeatRo = "1", HeadDia = "34.2", SeatHeight = "32", DatumToEnd = "64", DatuToGroove = "50", OverLeght = "102" },
        new ValveReadingRow { SerialNumber = 16, GrooveDia = "13", STNG = "3", STNU = "4", GroovePositon = "2", SeatRo = "2", HeadDia = "35", SeatHeight = "33", DatumToEnd = "66", DatuToGroove = "52", OverLeght = "104" },
         new ValveReadingRow { SerialNumber = 17, GrooveDia = "12.5", STNG = "1", STNU = "2", GroovePositon = "1", SeatRo = "1", HeadDia = "34.2", SeatHeight = "32", DatumToEnd = "64", DatuToGroove = "50", OverLeght = "102" },
