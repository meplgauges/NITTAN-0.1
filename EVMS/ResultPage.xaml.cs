...
namespace EVMS
{
            ...
            valveDataRows = new List<ValveReadingRow>
    {
        ...
        new ValveReadingRow { SerialNumber = 10, GrooveDia = "13", STNG = "3", STNU = "4", GroovePositon = "2", SeatRo = "2", HeadDia = "35", SeatHeight = "33", DatumToEnd = "66", DatuToGroove = "52", OverLeght = "104" },
